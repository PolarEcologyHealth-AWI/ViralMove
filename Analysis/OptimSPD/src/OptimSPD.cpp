...
// Output
sdp::Matrix3D<float> FMatrix;
sdp::Matrix3D<float> DMatrix1;
sdp::Matrix3D<float> DMatrix2;
sdp::Matrix3D<float> PMatrix1;
sdp::Matrix3D<float> PMatrix2;
...
)
{
  ...
  case 1: {    res1 = nextx - (int)(nextx);
    ...
    part1 = res1 * sdp::FMatrix[time+1][site][(int)(nextx)];
    part2 = res2 * sdp::FMatrix[time+1][site][(int)(nextx)-1];
...
//   
//   /// Terminal Reward
//   sdp::Matrix3D<float>FM_TR;
//   FM_TR.resize((sdp::MaxT-sdp::MinT)+1, sdp::NSites+1, sdp::MaxX+1, 0.0);
//   
...
//     for (int c = 0; c <= sdp::MaxX; ++c)
//     {
//       FM_TR[(sdp::MaxT-sdp::MinT)][r][c] = sdp::B0;
//     }
//   }
// 
//   sdp::FMatrix  = FM_TR;
//   
//   // sdp::Matrix3D<float>DMatrix1;
//   // sdp::DMatrix1.resize(sdp::NSites+1, (sdp::MaxT-sdp::MinT)+1,sdp::MaxX+1, 0.0);
//   // sdp::Matrix3D<float>DMatrix2;
//   // sdp::DMatrix2.resize(sdp::NSites+1, (sdp::MaxT-sdp::MinT)+1,sdp::MaxX+1, 0.0);
//   // sdp::Matrix3D<float>PMatrix1;
//   // sdp::PMatrix1.resize(sdp::NSites+1, (sdp::MaxT-sdp::MinT)+1,sdp::MaxX+1, 0.0);
//   // sdp::Matrix3D<float>PMatrix2;
//   // sdp::PMatrix2.resize(sdp::NSites+1, (sdp::MaxT-sdp::MinT)+1,sdp::MaxX+1, 0.0);
// 
