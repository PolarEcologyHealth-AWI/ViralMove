...
// RcppExport SEXP _EAAFsdp_Flying(SEXP timeSEXP, SEXP siteSEXP, SEXP xSEXP, SEXP dep_siteSEXP) {
// BEGIN_RCPP
...
// }
// // Init
// void Init(int MinT, int MaxT, int NSites, int MaxX, double w, double xc, int B0, Rcpp::NumericVector b0, Rcpp::NumericVector b1, Rcpp::NumericVector b2, double pred_a1, double pred_a2, double c, double speed, Rcpp::NumericVector WindAssist, Rcpp::NumericVector WindProb, Rcpp::NumericVector ZStdNorm, Rcpp::NumericVector PStdNorm, Rcpp::NumericVector nTR_x, Rcpp::NumericVector nTR_y, double decError, arma::mat dist, arma::mat bear, Rcpp::NumericVector y_gain, arma::mat y_expend);
// RcppExport SEXP _EAAFsdp_Init(SEXP MinTSEXP, SEXP MaxTSEXP, SEXP NSitesSEXP, SEXP MaxXSEXP, SEXP wSEXP, SEXP xcSEXP, SEXP B0SEXP, SEXP b0SEXP, SEXP b1SEXP, SEXP b2SEXP, SEXP pred_a1SEXP, SEXP pred_a2SEXP, SEXP cSEXP, SEXP speedSEXP, SEXP WindAssistSEXP, SEXP WindProbSEXP, SEXP ZStdNormSEXP, SEXP PStdNormSEXP, SEXP nTR_xSEXP, SEXP nTR_ySEXP, SEXP decErrorSEXP, SEXP distSEXP, SEXP bearSEXP, SEXP y_gainSEXP, SEXP y_expendSEXP) {
// BEGIN_RCPP
//     Rcpp::RNGScope rcpp_rngScope_gen;
...
//     Init(MinT, MaxT, NSites, MaxX, w, xc, B0, b0, b1, b2, pred_a1, pred_a2, c, speed, WindAssist, WindProb, ZStdNorm, PStdNorm, nTR_x, nTR_y, decError, dist, bear, y_gain, y_expend);
//     return R_NilValue;
// END_RCPP
// }
// // BackwardIteration
// Rcpp::List BackwardIteration(bool pbar);
// RcppExport SEXP _EAAFsdp_BackwardIteration(SEXP pbarSEXP) {
// BEGIN_RCPP
//     Rcpp::RObject rcpp_result_gen;
//     Rcpp::RNGScope rcpp_rngScope_gen;
...
// }
// // InitSim
// void InitSim(int MinT, int MaxT, int NSites, int MaxX, double w, double xc, int B0, Rcpp::NumericVector b0, Rcpp::NumericVector b1, Rcpp::NumericVector b2, double pred_a1, double pred_a2, double c, double speed, Rcpp::NumericVector WindAssist, Rcpp::NumericVector WindProb, Rcpp::NumericVector ZStdNorm, Rcpp::NumericVector PStdNorm, Rcpp::NumericVector nTR_x, Rcpp::NumericVector nTR_y, double decError, arma::mat dist, Rcpp::NumericVector y_gain, arma::mat y_expend, arma::cube FMatrix, arma::cube DMatrix1, arma::cube DMatrix2, arma::cube PMatrix1, arma::cube PMatrix2);
// RcppExport SEXP _EAAFsdp_InitSim(SEXP MinTSEXP, SEXP MaxTSEXP, SEXP NSitesSEXP, SEXP MaxXSEXP, SEXP wSEXP, SEXP xcSEXP, SEXP B0SEXP, SEXP b0SEXP, SEXP b1SEXP, SEXP b2SEXP, SEXP pred_a1SEXP, SEXP pred_a2SEXP, SEXP cSEXP, SEXP speedSEXP, SEXP WindAssistSEXP, SEXP WindProbSEXP, SEXP ZStdNormSEXP, SEXP PStdNormSEXP, SEXP nTR_xSEXP, SEXP nTR_ySEXP, SEXP decErrorSEXP, SEXP distSEXP, SEXP y_gainSEXP, SEXP y_expendSEXP, SEXP FMatrixSEXP, SEXP DMatrix1SEXP, SEXP DMatrix2SEXP, SEXP PMatrix1SEXP, SEXP PMatrix2SEXP) {
// BEGIN_RCPP
//     Rcpp::RNGScope rcpp_rngScope_gen;
//     Rcpp::traits::input_parameter< int >::type MinT(MinTSEXP);
//     Rcpp::traits::input_parameter< int >::type MaxT(MaxTSEXP);
...
//     InitSim(MinT, MaxT, NSites, MaxX, w, xc, B0, b0, b1, b2, pred_a1, pred_a2, c, speed, WindAssist, WindProb, ZStdNorm, PStdNorm, nTR_x, nTR_y, decError, dist, y_gain, y_expend, FMatrix, DMatrix1, DMatrix2, PMatrix1, PMatrix2);
//     return R_NilValue;
// END_RCPP
// }
// // simForaging
// arma::vec simForaging(double f_intensity, int time, int site, int x);
// RcppExport SEXP _EAAFsdp_simForaging(SEXP f_intensitySEXP, SEXP timeSEXP, SEXP siteSEXP, SEXP xSEXP) {
// BEGIN_RCPP
//     Rcpp::RObject rcpp_result_gen;
//     Rcpp::RNGScope rcpp_rngScope_gen;
...
// RcppExport SEXP _EAAFsdp_simFlying(SEXP decisionSEXP, SEXP timeSEXP, SEXP siteSEXP, SEXP xSEXP) {
// BEGIN_RCPP
//     Rcpp::RObject rcpp_result_gen;
//     Rcpp::RNGScope rcpp_rngScope_gen;
...
// RcppExport SEXP _EAAFsdp_forwardSim(SEXP IndSEXP, SEXP start_timeSEXP, SEXP start_siteSEXP, SEXP start_xSEXP) {
// BEGIN_RCPP
//     Rcpp::RObject rcpp_result_gen;
//     Rcpp::RNGScope rcpp_rngScope_gen;
...
//     {"_EAAFsdp_Flying", (DL_FUNC) &_EAAFsdp_Flying, 4},
//     {"_EAAFsdp_Init", (DL_FUNC) &_EAAFsdp_Init, 25},
//     {"_EAAFsdp_BackwardIteration", (DL_FUNC) &_EAAFsdp_BackwardIteration, 1},
//     {"_EAAFsdp_InitSim", (DL_FUNC) &_EAAFsdp_InitSim, 29},
//     {"_EAAFsdp_simForaging", (DL_FUNC) &_EAAFsdp_simForaging, 4},
//     {"_EAAFsdp_simFlying", (DL_FUNC) &_EAAFsdp_simFlying, 4},
//     {"_EAAFsdp_forwardSim", (DL_FUNC) &_EAAFsdp_forwardSim, 4},
//     {NULL, NULL, 0}
// };
// 
// RcppExport void R_init_EAAFsdp(DllInfo *dll) {
